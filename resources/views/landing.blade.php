        ...
        <div class="container mt-5">
            @foreach ($categories as $category)
                ...
                <div id="carouselExampleControls{{ $category->id }}" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        @foreach($cards->where('category_id', $category->id) as $card)
                            ...
                            @endif
                                <div class="col-md-4">
                                    <div class="card">
                                        <img src="{{ $card->img }}" class="card-img-top" alt="..." style="height: 200px;">
                                        <div class="card-body">
                    ...
                    @if ($counter > 3)
                    <button class="carousel-control-prev " type="button" data-bs-target="#carouselExampleControls{{ $category->id }}" data-bs-slide="prev" aria-label="Previous">
                        <span class="carousel-control-prev-icon rounded-pill" aria-hidden="true"></span>
                        <span class="visually-hidden ">Previous</span>
                    </button>
                    <button class="carousel-control-next rounded-circle" type="button" data-bs-target="#carouselExampleControls{{ $category->id }}" data-bs-slide="next" aria-label="Next">
